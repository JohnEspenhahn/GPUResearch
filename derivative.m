...
syms N_tot mu_h M_h X_tot pH2 pH_p pH(pH2,pH_p) k1 k2(pH2,pH_p) k3(pH2,pH_p) nH(pH2,pH_p) nH_2(pH2) ne(pH_p) k6 k7 k8(pH_p)
a = diff(k1*nH(pH2,pH_p)*pH(pH2,pH_p), pH2)
