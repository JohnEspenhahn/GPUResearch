...
public class ODEEntryFormat {
	...
	public static String format(ODEEntry e) {
		...
		sb.append("	double nH_p = sub_vec_nHx[1], nH2  = sub_vec_nHx[2], nHe_p = sub_vec_nHx[3]\n");
		sb.append("			 , nC_p = sub_vec_nHx[4], nO_p = sub_vec_nHx[5], nOH   = sub_vec_nHx[6]\n");
		sb.append("			 , nH2O = sub_vec_nHx[7], nCO  = sub_vec_nHx[8], nC2   = sub_vec_nHx[9]\n");
		sb.append("			 , nO2  = sub_vec_nHx[10], nHCO_p = sub_vec_nHx[11], nCH = sub_vec_nHx[12]\n");
		sb.append("			 , nCH2 = sub_vec_nHx[13], nCH3_p = sub_vec_nHx[14], nH_m = sub_vec_nHx[15]\n");
		sb.append("			 , nH2_p = sub_vec_nHx[16], nH3_p = sub_vec_nHx[17], nCH_p = sub_vec_nHx[18]\n");
